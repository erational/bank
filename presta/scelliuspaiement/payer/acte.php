 ...
 * @return array|string
 */
function presta_scelliuspaiement_payer_acte_dist($config, $id_transaction, $transaction_hash, $options = array()){
	...
	return recuperer_fond('presta/scelliuspaiement/payer/acte', $contexte);
}
